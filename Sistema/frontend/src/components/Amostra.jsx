...
const Amostra = () => {
	...
	const [numAmostra, setAmostra] = useState('');
	...
	return (
		<div style={{backgroundColor: '', display:'flex', justifyContent:'center' ,width: '100%', height:'100vh', flexWrap: 'wrap', alignItems:'center'}}>
			<div style={{backgroundColor: '#eeeeee', display:'flex', justifyContent:'center' ,width: '80%', height:'100%', flexWrap: 'wrap', borderRadius:'20px', opacity : '0.98'}}>
				...
				<div style={{backgroundColor: '', display:'flex', width: '100%', height:'60%'}}>
					<div style={{backgroundColor: '', display:'flex',  flexDirection: 'column', alignItems: 'center', justifyContent:'center', width: '100%', height:'100%'}}>
						<div style={{backgroundColor: '', display:'flex',  flexDirection: 'column', height:'50px', width:'500px', margin:'30px 0'}}>
							...
							<Input style= {{width: '90%',  padding: '10px', border: 'none', marginBottom: '10px', borderRadius: '5px'}}
				...
				<div>
						<div style={{backgroundColor: '', display:'flex',  flexDirection: 'column', alignItems: 'center', justifyContent:'center', width: '100%', height:'100%'}}>
							...
							<Input style={{width: '90%',  padding: '10px', border: 'none', marginBottom: '10px', borderRadius: '5px'}}
								value={numAmostra} onChange={(e) => numAmostra(e.target.value)}
							></Input>	
						</div>
					</div>
					
				<div style={{backgroundColor: '', display:'flex', width: '100%', height:'20%', alignItems:'center', justifyContent:'center'}}>
					<button onClick={() => Salvar() } style={{fontFamily: 'tisa_sans_probold', borderRadius: '10px', border:'none', padding: '10px 15px', backgroundColor: '#FFFFFF', color: '#164C34'}}>Salvar</button>                                
				</div>   	
